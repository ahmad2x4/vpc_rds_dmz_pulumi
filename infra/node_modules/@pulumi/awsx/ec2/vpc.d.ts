...
export declare class Vpc extends pulumi.ComponentResource {
    ...
    readonly publicSubnets: x.ec2.Subnet[];
    readonly privateSubnets: x.ec2.Subnet[];
    readonly isolatedSubnets: x.ec2.Subnet[];
    /**
     ...
     */
    internetGateway?: x.ec2.InternetGateway;
    /**
     * The nat gateways created to allow private subnets access to the internet.
     * Only available if this was created using [VpcArgs].
     */
    readonly natGateways: x.ec2.NatGateway[];
    constructor(name: string, args?: VpcArgs, opts?: pulumi.ComponentResourceOptions);
    constructor(name: string, args?: ExistingVpcArgs, opts?: pulumi.ComponentResourceOptions);
    private partition;
    private addSubnet;
    getSubnets(type: VpcSubnetType): x.ec2.Subnet[];
    getSubnetIds(type: VpcSubnetType): pulumi.Output<string>[];
    /**
     ...
     */
    addInternetGateway(name: string, subnets?: x.ec2.Subnet[], args?: aws.ec2.InternetGatewayArgs, opts?: pulumi.ComponentResourceOptions): x.ec2.InternetGateway;
    /**
     ...
     */
    addNatGateway(name: string, args: x.ec2.NatGatewayArgs, opts?: pulumi.ComponentResourceOptions): x.ec2.NatGateway;
    /**
