...
import * as mod from ".";
import * as x from "..";
export declare abstract class TargetGroup extends pulumi.ComponentResource implements x.ecs.ContainerPortMappingProvider, x.ecs.ContainerLoadBalancerProvider, x.lb.ListenerDefaultAction {
    readonly loadBalancer: mod.LoadBalancer;
    readonly targetGroup: aws.lb.TargetGroup;
    readonly vpc: x.ec2.Vpc;
    readonly listeners: x.lb.Listener[];
    constructor(type: string, name: string, loadBalancer: mod.LoadBalancer, args: TargetGroupArgs, opts?: pulumi.ComponentResourceOptions);
    private dependencies;
    containerPortMapping(): pulumi.Input<aws.ecs.PortMapping>;
    containerLoadBalancer(): pulumi.Input<x.ecs.ContainerLoadBalancer>;
    listenerDefaultAction(): pulumi.Input<mod.ListenerDefaultActionArgs>;
    /** Do not call directly.  Intended for use by [Listener] and [ListenerRule] */
    registerListener(listener: x.lb.Listener): void;
    /**
 ...
 */
export declare type TargetType = "instance" | "ip" | "lambda";
