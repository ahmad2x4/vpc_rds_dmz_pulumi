...
import * as mod from ".";
import * as x from "..";
export declare type NetworkProtocol = "TCP" | "TLS" | "HTTP" | "HTTPS";
export declare class NetworkLoadBalancer extends mod.LoadBalancer {
    ...
    createListener(name: string, args: NetworkListenerArgs, opts?: pulumi.ComponentResourceOptions): mod.NetworkListener;
    createTargetGroup(name: string, args: NetworkTargetGroupArgs, opts?: pulumi.ComponentResourceOptions): mod.NetworkTargetGroup;
}
/**
 ...
 * for more details.
 */
export declare class NetworkTargetGroup extends mod.TargetGroup {
    readonly loadBalancer: NetworkLoadBalancer;
    readonly listeners: x.lb.NetworkListener[];
 ...
 * for more details.
 */
export declare class NetworkListener extends mod.Listener implements x.apigateway.IntegrationRouteTargetProvider {
    readonly loadBalancer: NetworkLoadBalancer;
    readonly defaultTargetGroup?: x.lb.NetworkTargetGroup;
    ...
    target(name: string, parent: pulumi.Resource): pulumi.Input<x.apigateway.IntegrationTarget>;
}
